  ...
  <div class="min-h-screen bg-stone-50 flex items-center justify-center px-4 py-10">
    <div class="w-full max-w-sm">
      <div class="flex flex-col items-center mb-8">
        ...
        <h1 class="font-display text-2xl font-semibold text-stone-900">Welcome back</h1>
        <p class="text-stone-500 text-sm mt-1">Log in to keep reviewing your words.</p>
      </div>
      ...
      <p class="text-center text-sm text-stone-500 mt-5">
        New here?
        <router-link to="/signup" class="text-pink-600 font-medium hover:text-pink-700"
